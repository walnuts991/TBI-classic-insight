...
function Login() {
  ...
  return (
    <main className={`min-h-screen font-sans transition-colors ${styles.page}`}>
      <header className={`sticky top-0 z-20 border-b ${styles.nav}`}>
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 md:px-10">
          ...
          <div className={`flex items-center gap-3 ${styles.icon}`}>
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-3 py-2 text-xs font-bold transition-colors ${styles.subtle}`}
